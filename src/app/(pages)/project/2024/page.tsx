...
export const metadata: Metadata = {
  title: "OSS25| FOSS Community UOK ",
  description: "Open Source Summit at UOK Organized by FOSS UOK.",
  openGraph: {
    ...
    <div className={classes.wrapper}>
      ...
      <Container size={900}>
        <div className={classes.partners}>
          <div>
            <h3 className={classes.partnerTitle}>Diamond Sponsors</h3>
            ...
            <h3 className={classes.partnerTitle}>Beverage Partner</h3>
            <div className={classes.partnerLogoRow}>
              <div>
                <img
            ...
            <h3 className={classes.partnerTitle}>Community Partners</h3>
            <div className={classes.partnerLogoRow}>
              <div>
                <img
      ...
      <Container size={1200}>
        ...
        <div className={classes.speakers}>
          {speakerList.map((speaker) => {
            return (
              <div className={classes.speakerCard} key={speaker.slug}>
                  ...
                  <div className={classes.speakerLink}>
                    <a href={speaker.linkedin}>
                      <svg
                        ...
                        className={classes.speakerLinkedin}
                        viewBox="-4 0 52 52"
                      >
                ...
                <span className={classes.speakerName}>{speaker.name}</span>
      ...
      <Container size={1200}>
        ...
        <span className={classes.eventSectionDes}>
          Join us for a series of workshops to learn from the best in the
          industry.
        </span>
      ...
      <Container size={1200}>
        <h2 className={classes.commiteeSectionTitle}>Summit Committee</h2>

        <SummitCommittee />
      </Container>

      <Container size={1200}>
        <h2 className={classes.commiteeSectionTitle}>Workshop Committee</h2>
        <WorkshopCommittee />
      </Container>
