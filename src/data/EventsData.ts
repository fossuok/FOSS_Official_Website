...
export const eventsData: EventCardProps[] = [
	// Summit 26 events
	{
		...
		imageUrl: {
			src: `${imgUrl}/flyers/summit-26/ds26-topic-nushan.webp`,
			height: 0,
			width: 0,
		},
		speakers: [
			{
				name: "Nushan Vitharana",
				role: "Senior Business Analyst at LSEG",
	...
	{
		id: 20,
		title: "Session 2: Building Transparent LLM Applications: A Guide to Monitoring and Observability",
		...
		contents: {
			...
			timerange: "10.30 AM",
			location:
				"Academic Building-Scaled-08-1, FCT, University of Kelaniya",
	...
	{
		id: 18,
		title: "Micro-frontend Architecture to Mobile Applications (Android and IOS)",
	...
	//ods workshop 2
	{
		...
		register:
			"https://www.youtube.com/watch?v=IXItNYTiGBA&feature=youtu.be",
		open: true,
		record: true,
		date: "May 03",
		year: "2025",
	...
	// pre-summit'24 workshop 06
	{
		...
		year: "2024",
		description: [
			"Integrating DevSecOps into the SDLC for Robust Protection",
		],
		imageUrl: {
