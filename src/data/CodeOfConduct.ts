export const data = [
  ...
  },
  {
    ...
    pre_list: [
      "If you experience or witness a violation of this code of conduct, please report it immediately to a member of the event staff or volunteer.",
      "You may report anonymously if you prefer.",
      "Staff and volunteers will investigate all reports and take appropriate action, which may include verbal warnings, removal from the event, or reporting to law enforcement.",
    ],
    description: "",
    post_list: [],
  },
  ...
  {
    title: "Changes to this Code of Conduct",
    pre_list: [],
    description:
